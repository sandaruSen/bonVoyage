...
router.get('/', function(req, res, next) {
    ...
    destination.find( {"category":"rainforests"} , function(err,destinations){
        if(err)
            console.log(err);
        ...
        // res.render('rainforests', { name: name, district:district ,category:category ,description:description,imageURL:imageURL, rating:rating });
        res.render('rainforests',{destinations: destinations});
    });
