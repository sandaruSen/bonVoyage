...
router.get('/', function(req, res, next) {
    ...
    destination.find( {"category":"wild life"} , function(err,destinations){
        if(err)
            console.log(err);
        ...
        // res.render('wildlife', { name: name, district:district ,category:category ,description:description,imageURL:imageURL, rating:rating });
        res.render('wildlife',{destinations: destinations});
    });
